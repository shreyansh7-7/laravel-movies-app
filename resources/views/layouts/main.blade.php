...
<body class="font-sans bg-gray-900 text-white md:ml-16 md:mr-16">
                ...
                <div class="relative">
                    ...
                    <div class="absolute top-0">
                        <svg class="fill-current w-4 text-gray-500 mt-2 ml-2" viewBox="0 0 24 24">
                            <path d="M10 2a8 8 0 015.29 13.29l4.58 4.59-1.42 1.41-4.59-4.58A8 8 0 1110 2zm0 2a6 6 0 100 12A6 6 0 0010 4z"/>
                        </svg>
                    </div>
                </div>
    ...
    <footer class="border border-t border-gray-800">
        <div class="container mx-auto text-sm px-4 py-6">
            Powered by <a href="#" class="underline hover:text-gray-300">TMDb API</a>
        </div>
    </footer>
</body>
</html>